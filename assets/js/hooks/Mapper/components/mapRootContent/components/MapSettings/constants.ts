...
export const SYSTEMS_CHECKBOXES_PROPS: SettingsListItem[] = [
  ...
  {  //fanaberiatracker - dwa checkboxy w menu do odpalania animowanych ramek na selected-systemie
    prop: InterfaceStoredSettingsProps.show_animated_border, //fanaberia - animowana ramka
    label: 'Animate selected-system border',
    type: 'checkbox',
  },
  {
    prop: InterfaceStoredSettingsProps.show_animated_outline, //fanaberia - animowany outline
    label: 'Animate selected-system outline',
    type: 'checkbox',
  },
];
